    ...
    <footer className="border-t border-white/5 bg-[#090910]/95">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-gradient text-2xl font-black uppercase tracking-[0.55em] drop-shadow-[0_0_18px_rgba(181,255,63,0.35)]">
              D<span className="text-white">EYAN</span>
            </p>
            <p className="max-w-sm text-sm text-fg-muted mt-1">
              Dark cinematic hip-hop & underground soundscapes from Bucharest.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-4 text-xs text-fg-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="mailto:realdeyan@gmail.com" className="hover:text-fg">
              realdeyan@gmail.com
            </a>
